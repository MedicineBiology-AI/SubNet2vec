...
def main():
    ...
    file2 = 'result3/gene_p_0.25.txt'
    file3 = "result3/sub_p_0.25.txt"
    y_lab_sub_gene,ave_y_pre_sub_gene,had_y_pre_sub_gene,l1_y_pre_sub_gene,l2_y_pre_sub_gene, Menche_X_test=mm(file1)
    ...
    false_positive_rate5, true_positive_rate5, pre5, rec5, pr5 = s_ab(Menche_X_test, y_lab_sub_gene, 's_ab1.txt', flag=0)
    auc5=auc(false_positive_rate5, true_positive_rate5)
    print("Menche AUC:",auc5)

    false_positive_rate6, true_positive_rate6, pre6, rec6, pr6 = s_ab(Menche_X_test, y_lab_sub_gene, 'phenonet_result1.txt', flag=1)
    auc6=auc(false_positive_rate6, true_positive_rate6)
    print("PhenoNet AUC",auc6)
    plt.figure()
    ...
    plt.savefig('disease_disease_ROC.eps', format='eps', dpi=300)
    plt.savefig('disease_disease_ROC.jpg', format='jpg', dpi=300)
    ...
    plt.plot(rec5, pre5, label='Menche (AURR=%0.3f)' % pr5)
    plt.plot(rec6, pre6, label='PhenoNet (AUPR=%0.3f)' % pr6)
    ...
    plt.savefig('disease_disease_PR.eps', format='eps', dpi=300)
    plt.savefig('disease_disease_PR.jpg', format='jpg', dpi=300)
    plt.show()
